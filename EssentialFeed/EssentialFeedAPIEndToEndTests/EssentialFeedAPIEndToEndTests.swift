...
final class EssentialFeedAPIEndToEndTests: XCTestCase {
    ...
    func test_endToEndTestServerGETFeedResult_matchedFixedTestAccountData() {
        ...
        case let .success(imageFeed):
            ...
            XCTAssertEqual(imageFeed[0], expectedImage(at: 0), "Unexpected item found at index \(0)")
            XCTAssertEqual(imageFeed[1], expectedImage(at: 1), "Unexpected item found at index \(1)")
            XCTAssertEqual(imageFeed[2], expectedImage(at: 2), "Unexpected item found at index \(2)")
            XCTAssertEqual(imageFeed[3], expectedImage(at: 3), "Unexpected item found at index \(3)")
            XCTAssertEqual(imageFeed[4], expectedImage(at: 4), "Unexpected item found at index \(4)")
            XCTAssertEqual(imageFeed[5], expectedImage(at: 5), "Unexpected item found at index \(5)")
            XCTAssertEqual(imageFeed[6], expectedImage(at: 6), "Unexpected item found at index \(6)")
            XCTAssertEqual(imageFeed[7], expectedImage(at: 7), "Unexpected item found at index \(7)")
    ...
    func test_endToEndTestServerGETFeedImageDataResult_matchesFixedTestAccountData() {
        ...
        default: XCTFail("Expected successful image data result, got no instead")
        }
    }
